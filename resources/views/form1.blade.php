...
<center>
    <button class="btn-edit-custom" style="margin: 0 auto;">แก้ไข</button>
</center>
...
<center>
    @if (isset($projectId))
    <div class="step-wrapper" style="margin: 2rem auto; max-width: 1200px;">
...
<div class="flex justify-center mt-5">
    <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4" style="max-width: 1200px; margin: 0 auto;">
        ...
        <div class="card shadow">
            <center>
                <div class="card-header bg-warning text-black">
                    <h4 class="mb-0">แบบฟอร์มโครงการ</h4>
                </div>
            </center>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-3 mt-3">
                                ...
                                <div class="mb-3" style="flex: 1;">
                                    <label for="responsible_person" class="mb-0" style="font-size: 14px;">
                                        ผู้รับผิดชอบ
                                    </label><br>
                                    @php
                                    ...
                                    <select id="responsible_person"
                                        ...
                                        @if($selectedPerson)
                                        <option value="{{ $selectedPerson }}" selected>
                                            {{ $selectedPerson }}
                                        </option>
                                        @else
                                ...
                                {{-- โทรศัพท์ --}}
                                <div style="flex: 1;">
                                    <label class="mb-0" style="font-size:14px">โทรศัพท์</label>
                                ...
                                {{-- อีเมล --}}
                                <div style="flex: 1;">
                                    <label class="mb-0" style="font-size:14px">อีเมล</label>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        ...
                                        <label class="btn btn-outline-success w-100 text-start"
                                            for="subgoal{{ $subgoal->id }}" style="font-size: 14px;">
                                            {{ $subgoal->name }}
                                        </label>
                                    </div>
                                    @endforeach
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap justify-content-center">
                                <label class="mb-0" style="font-size:14px">เริ่ม</label>
                                <input type="date" id="sdate" class="form-control" name="sdate" style="width: 200px;"
                                    value="{{ old('sdate', $plan->sdate ?? '') }}">

                                <label class="mb-0 ms-3" style="font-size:14px">สิ้นสุด</label>
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-center">
                                ...
                                <span class="me-3" style="font-size:14px">ปี</span>
                                ...
                                <span class="me-3" style="font-size:14px">เดือน</span>
                                ...
                                <span class="me-4" style="font-size:14px">วัน</span>
                            </div>
                        </div><br>
